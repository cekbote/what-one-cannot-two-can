...
def parse_args(base_parser, args, namespace):
    str2bool = lambda value: value.lower() in ('yes', 'true', 't', 'y', '1') if isinstance(value, str) else bool(value)
    ...
    parser.add_argument('--eval_freq', default=300, type=int) # in iterations
    ...
    parser.add_argument('--n_head_first_layer', default=2, type=int)
    ...
    parser.add_argument('--use_relative_positional_encoding', default=True, type=str2bool)
    ...
    parser.add_argument('--chain', default='icl', choices=['switch', 'random', 'icl'])
    ...
    # Logging args
    parser.add_argument('--log_less', default=True, type=lambda x: (str(x).lower() == 'true'))
    
    # Construction
    parser.add_argument('--construction', default='new-construction', choices=['new-construction'])
